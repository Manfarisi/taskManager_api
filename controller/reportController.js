...
const exportTaskReport = async (req, res) => {
  try {
    ...
    worksheet.columns = [
      ...
      { header: "Titlte", key: "title", width: 30 },
...
const exportUserkReport = async (req, res) => {
  try {
      ...
      if (task.assignedTo) {
        task.assignedTo.forEach((assignedUser) => {
          ...
          if (task.status === "Pending") {
            ...
            userTaskMap[assignedUser._id].inProgresTask += 1;
    ...
    worksheet.columns = [
      ...
      { header: "Total Assifned Tasks", key: "taskCount", width: 20 },
...
module.exports = { exportTaskReport, exportUserkReport };
